...
def main():
    ...
    ####################################################################
    save_path = "/home/jovyan/Encryption-friendly_LLM_Architecture/ciphertext/converted_weights/converted_weights_rte_eval.pth"
    ...
    ## `rte_eval_inputs/input(index)_2ly_rte.pth`, we set the path as the following   ##
    ...
    for i in range(0,277):
        inp = torch.load(f'/home/jovyan/Encryption-friendly_LLM_Architecture/plaintext/fine-tuning_data/rte_eval_inputs/input{i}_2ly_rte.pth')
        container.add(f'input_{i}', inp)
        inp = torch.load(f'/home/jovyan/Encryption-friendly_LLM_Architecture/plaintext/fine-tuning_data/rte_eval_masks/mask{i}_2ly_rte.pth')
